...
var Arrive = function(a, b, c) {
    ...
    if (a.MutationObserver && "undefined" != typeof HTMLElement) {
        var d = 0
          , e = function() {
            ...
            return {
                ...
                toElementsArray: function(b) {
                    return "undefined" == typeof b || "number" == typeof b.length && b !== a || (b = [b]),
                    b
                }
            }
        }()
          , f = function() {
            ...
            return a.prototype.addEvent = function(a, b, c, d) {
                ...
                return this._beforeAdding && this._beforeAdding(e),
            ...
            a.prototype.removeEvent = function(a) {
                for (var c, b = this._eventsBucket.length - 1; c = this._eventsBucket[b]; b--)
                    a(c) && (this._beforeRemoving && this._beforeRemoving(c),
          ...
          , g = function(b, d) {
            ...
            return g.beforeAdding(function(c) {
                ...
                c.selector,
                c.callback;
                (e === a.document || e === a) && (e = document.getElementsByTagName("html")[0]),
            ...
            this.bindEvent = function(a, b, c) {
                b = e.mergeArrays(i, b);
                for (var d = e.toElementsArray(this), f = 0; f < d.length; f++)
            ...
            this.unbindEventWithSelectorOrCallback = function(a) {
                ...
                f = "function" == typeof a ? function(a) {
                    for (var e = 0; e < b.length; e++)
                        if ((this === c || a.target === b[e]) && a.callback === d)
                            return !0;
                    return !1
                }
                : function(d) {
                    for (var e = 0; e < b.length; e++)
                        if ((this === c || d.target === b[e]) && d.selector === a)
                            return !0;
                    return !1
                }
                ,
            ...
            this.unbindEventWithSelectorAndCallback = function(a, b) {
                ...
                g.removeEvent(function(e) {
                    for (var f = 0; f < d.length; f++)
                        if ((this === c || e.target === d[f]) && e.selector === a && e.callback === b)
                            return !0;
                    return !1
                })
            }
          ...
          , h = function() {
            function h(a) {
                ...
                return a.fireOnAttributesModification && (b.attributes = !0),
                b
            }
            function i(a, b) {
            ...
            function k(a, b, f) {
                if (e.matchesSelector(a, b.selector) && (a._id === c && (a._id = d++),
                -1 == b.firedElems.indexOf(a._id))) {
                    if (b.options.onceOnly) {
                        if (0 !== b.firedElems.length)
                            return;
            ...
            function f(a, b) {
                a.forEach(function(a) {
                    var c = a.removedNodes
                      , f = (a.target,
                    []);
                    null !== c && c.length > 0 && e.checkChildNodesRecursively(c, b, h, f),
                    e.callCallbacks(f)
                })
            }
            function h(a, b) {
        ...
        m(Window.prototype);
        var n = {};
        return l(j, n, "unbindAllArrive"),
        l(k, n, "unbindAllLeave"),
        n
    }
