...
module.exports = {
	...
	initials:function(req,res){
		//college_name.   //enrollment_number.    //email.     //type
				...
				if(req.query.password!=result[0].password)
				{
					console.log("Password Did Not Match");
							...
							var user = {
													    ...
													    semester:( process.env.year - result[0].year_of_admission)*2 + Number(process.env.odd_even)
	...
	feedback:function(req,res){
		console.log(req.session.temp.college_name);
